...
$adm = $GLOBALS['db']->GetRow("SELECT srv_password, email FROM " . DB_PREFIX . "_admins WHERE aid = '".$userbank->GetAid()."'");
$srvpwset = !empty($adm['srv_password']);

$theme->assign('srvpwset',				$srvpwset);
$theme->assign('email',					$adm['email']);
