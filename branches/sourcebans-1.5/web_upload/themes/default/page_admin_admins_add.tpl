  ...
  <div id="add-group">
    ...
    <table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
      ...
      <tr>
        ...
        <td>
          <div align="left">
            <input type="checkbox" TABINDEX=6 id="a_useserverpass" name="a_useserverpass" onclick="$('a_serverpass').disabled = !$(this).checked;" />
            <input type="password" TABINDEX=7 class="submit-fields" id="a_serverpass" name="a_serverpass" disabled="disabled" />
          </div>
