          ...
          <form action="{$active}" id="admin-page-content" method="post">
            <fieldset>
              ...
              <span class="badentry" id="name.msg">Invalid name supplied.</span>
              ...
              <span class="badentry" id="type.msg">Invalid type supplied.</span>
              ...
              <span class="badentry" id="steam.msg">Invalid Steam ID supplied.</span>
              ...
              <span class="badentry" id="email.msg"></span>
