          ...
          <div id="admin-page-content">
            <form action="{$active}" id="pane-settings" method="post">
              <fieldset>
                ...
                <div id="password_minlength.msg" class="badentry"></div>
                <div>
                ...
                <div id="intro_title.msg" class="badentry"></div>
                <div>
                ...
                <div id="intro_text.msg" class="badentry"></div>
                <div>
                ...
                <div id="hide_adminname.msg" class="badentry"></div>
                        ...
                        <table width="100%" cellpadding="0" class="listtable" cellspacing="0">
                          <tr>
                            ...
                            <td class="listtable_1" width="66%">
                              <select id="admin" onmouseup="$('admin_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 251px;">
                          ...
                          <tr>
                            ...
                            <td class="listtable_1"><input id="message" value="" onmouseup="$('message_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 249px;" /></td>
                          </tr>
                          <tr>
                            <td align="center" class="listtable_1"><input id="date_" type="radio" name="type" value="date" /></td>
                            <td class="listtable_1">{$lang_date}</td>
                            <td class="listtable_1">
                              <input id="day" value="DD" onmouseup="$('date_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 25px;">.<input id="month" value="MM" onmouseup="$('date_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 25px;">.<input id="year" value="YYYY" onmouseup="$('date_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 40px;">
                              &nbsp;<input id="fhour" value="00" onmouseup="$('date_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 25px;">:<input id="fminute" value="00" onmouseup="$('date_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 25px;">
                              -&nbsp;<input id="thour" value="23" onmouseup="$('date_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 25px;">:<input id="tminute" value="59" onmouseup="$('date_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 25px;">
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td class="listtable_1">
                              <select id="type" onmouseup="$('type_').checked = true" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215); width: 251px;">
