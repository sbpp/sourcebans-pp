          <h3>{$language->submit_ban|ucwords}</h3>
          ...
          <form action="" enctype="multipart/form-data" id="submit-main" method="post">
            <fieldset>
              <div>
              ...
              <div>
                <label for="reason">{$language->reason} (Please write down a descriptive comment. So NO comments like: "hacking"):</label>
                <textarea class="submit-fields" cols="30" {nid id="reason"} rows="5"></textarea>
                <span class="mandatory">*</span>
              </div>
              <div>
                <label for="subname">{$language->name}:</label>
                <input class="submit-fields" maxlength="64" {nid id="subname"} />
                <span class="mandatory">*</span>
              </div>
              <div>
                <label for="subemail">{$language->email_address}:</label>
                <input class="submit-fields" maxlength="128" {nid id="subemail"} />
                <span class="mandatory">*</span>
              </div>
              <div>
                <label for="server">{$language->server}:</label>
              ...
              <div>
                <label for="demo">{$language->demo} (<a href="#" id="add_demo">{$language->add}</a>):</label>
