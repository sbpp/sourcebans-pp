          ...
          <div id="admin-page-content">
            ...
            <form action="{$active}" id="pane-add" method="post">
              <fieldset>
                ...
                <div id="rcon_confirm.msg" class="badentry"></div>
                <div>
                ...
                <div>
                  <label for="groups">{help_icon title="$lang_server_admin_groups" desc="Choose a group to add this server to. Server groups are used for adding admins to specific sets of servers."}{$lang_server_admin_groups}</label>
