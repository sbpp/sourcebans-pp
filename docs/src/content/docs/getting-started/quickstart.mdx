...
the bundled SourceMod plugins are under
[GPLv3](https://www.gnu.org/licenses/gpl-3.0.html). Hobby / community
self-hosting (the typical case for an admin reading this page) is
free under both. If you're a game-server hosting provider planning
to offer SourceBans++ to your customers as a hosted or managed
service, see [the FAQ "Is it free?" entry](/faq/#is-it-free)
**before** continuing — that use case is reserved by ELv2 and a
separate commercial licence is needed.

Read the summary the wizard surfaces, tick **I have read and accept
the license above.**, click **Continue**.
