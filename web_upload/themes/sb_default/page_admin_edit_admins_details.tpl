...
<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  ...
  <tr>
    ...
    <td>
      <div align="left">
        <input type="checkbox" id="a_useserverpass" name="a_useserverpass"{if $a_spass} checked="checked"{/if} TABINDEX=6 onclick="$('a_serverpass').set('disabled', !$(this).get('checked'));" /> <input type="password" TABINDEX=7 class="submit-fields" name="a_serverpass" id="a_serverpass"{if !$a_spass} disabled="disabled"{/if} />
      </div>
