...
<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  <tr>
    ...
    <td><div align="left">
        <input type="password" onblur="xajax_CheckPassword(-{$user_aid}-, $('current').get('value'));" class="submit-fields" id="current" name="current" />
      </div>
...
<table width="90%" border="0" style="border-collapse:collapse;" id="group.details" cellpadding="3">
  ...
  <tr>
    ...
    <td><div align="left">
        <input type="password" onblur="xajax_CheckSrvPassword(-{$user_aid}-, $('scurrent').get('value'));" class="submit-fields" id="scurrent" name="scurrent" />
      </div>
