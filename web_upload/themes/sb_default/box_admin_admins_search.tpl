	  	...
	  	<tr>
	  		...
	  		<div class="panel">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" width="66%"><input type="text" id="nick" value="" onmouseup="$('name_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;"></td>
				</tr>       
			    <tr>
				...
				<tr>
			        ...
			        <td class="listtable_1" width="66%"><input type="text" id="admemail" value="" onmouseup="$('admemail_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;"></td>
				</tr>
				{/if}
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select id="webgroup" onmouseup="$('webgroup_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			        	<select id="srvadmgroup" onmouseup="$('srvadmgroup_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			        	<select id="srvgroup" onmouseup="$('srvgroup_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select id="admwebflag" name="admwebflag" onblur="getMultiple(this, 1);" size="5" multiple onmouseup="$('admwebflags_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
						<select id="admwebflag" name="admsrvflag" onblur="getMultiple(this, 2);" size="5" multiple onmouseup="$('admsrvflags_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select id="server" onmouseup="$('admin_on_').set('checked', true)" style="border: 1px solid #000000; font-size: 12px; background-color: rgb(215, 215, 215);width: 250px;">
