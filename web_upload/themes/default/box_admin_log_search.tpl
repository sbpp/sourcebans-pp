	  		...
	  		<div class="panel">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" width="66%">
						<select class="select" id="admin" onmouseup="$('admin_').set('checked', true)" style="width: 250px;">
				 ...
				 <tr>
			        ...
			        <td class="listtable_1"><input class="textbox" type="text" id="message" value="" onmouseup="$('message_').set('checked', true)" style="width: 250px;"></td>
				</tr>
			    <tr>
				    ...
				    <td class="listtable_1" >
			        	<input class="textbox" type="text" id="day" value="DD" onmouseup="$('date_').set('checked', true)" style="width: 25px;">.<input class="textbox" type="text" id="month" value="MM" onmouseup="$('date_').set('checked', true)" style="width: 25px;">.<input class="textbox" type="text" id="year" value="YYYY" onmouseup="$('date_').set('checked', true)" style="width: 40px;">
						&nbsp;<input class="textbox" type="text" id="fhour" value="00" onmouseup="$('date_').set('checked', true)" style="width: 25px;">:<input class="textbox" type="text" id="fminute" value="00" onmouseup="$('date_').set('checked', true)" style="width: 25px;">
						-&nbsp;<input class="textbox" type="text" id="thour" value="23" onmouseup="$('date_').set('checked', true)" style="width: 25px;">:<input class="textbox" type="text" id="tminute" value="59" onmouseup="$('date_').set('checked', true)" style="width: 25px;">
			        </td>
			    </tr>
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select class="select" id="type" onmouseup="$('type_').set('checked', true)" style="width: 250px;">
