	  	...
	  	<tr>
	  		...
	  		<div class="panel">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" width="66%"><input class="textbox" type="text" id="nick" value="" onmouseup="$('name').set('checked', true)" style="width: 87%;"></td>
				</tr>       
			    <tr>
			        ...
			        <td class="listtable_1" >
			            <input class="textbox" type="text" id="steamid" value="" onmouseup="$('steam_').set('checked', true)"style="width: 50%; margin-right: 12px;"><select class="select" id="steam_match" onmouseup="$('steam_').set('checked', true)" style="width: 33%;">
				...
				<tr>
					...
					<td class="listtable_1" ><input class="textbox" type="text" id="ip" value="" onmouseup="$('ip_').set('checked', true)"style="width: 87%;"></td>
				</tr>
				{/if}
			    <tr>
			        ...
			        <td class="listtable_1" ><input class="textbox" type="text" id="ban_reason" value="" onmouseup="$('reason_').set('checked', true)" style="width: 87%;"></td>
			    </tr>
				<tr>
			        ...
			        <td class="listtable_1" >
			        	<input class="textbox" type="text" id="day" value="DD" onmouseup="$('date').set('checked', true)" style="width: 22%;">
			            <input class="textbox" type="text" id="month" value="MM" onmouseup="$('date').set('checked', true)" style="width: 22%;">
			            <input class="textbox" type="text" id="year" value="YY" onmouseup="$('date').set('checked', true)" style="width: 24%;"> 
			        </td>
			  	</tr>
				<tr>
			        ...
			        <td class="listtable_1" >
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td>
						            <select class="select" id="length_type" onmouseup="$('length_').set('checked', true)" style="width: 60px; margin-right: 12px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			            <select class="select" id="ban_type" onmouseup="$('ban_type_').set('checked', true)" style="width: 95%;">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select class="select" id="ban_admin" onmouseup="$('admin').set('checked', true)" style="width: 95%;">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select class="select" id="server" onmouseup="$('where_banned').set('checked', true)" style="width: 95%;">
				...
				<tr>
			        ...
			        <td class="listtable_1" ><input class="textbox" type="text" id="ban_comment" value="" onmouseup="$('comment_').set('checked', true)" style="width: 87%;"></td>
			    </tr>
				{/if}
			    <tr>
