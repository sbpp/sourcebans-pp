	...
	<div id="footer">
		<div id="mainwrapper" style="text-align: center;">
			...
			<div id="footqversion" style="line-height: 20px;"><a style="color: #C1C1C1" href="https://github.com/Sarabveer/SourceBans-Fork" target="_blank">SourceBans</a> {$SB_VERSION}{$SB_REV}</div>
