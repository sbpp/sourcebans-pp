	  	...
	  	<tr>
	  		...
	  		<div class="panel">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" width="66%"><input class="textbox" type="text" id="nick" value="" onmouseup="$('name_').set('checked', true)" style="width: 353px;"></td>
				</tr>       
			    <tr>
				    ...
				    <input class="textbox" type="text" id="steamid" value="" onmouseup="$('steam_').set('checked', true)" style="width: 233px; margin-right: 15px;"><select class="select" id="steam_match" onmouseup="$('steam_').set('checked', true)" style="width: 105px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" width="66%"><input class="textbox" type="text" id="admemail" value="" onmouseup="$('admemail_').set('checked', true)" style="width: 353px;"></td>
				</tr>
				{/if}
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select class="select" id="webgroup" onmouseup="$('webgroup_').set('checked', true)" style="width: 379px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			        	<select class="select" id="srvadmgroup" onmouseup="$('srvadmgroup_').set('checked', true)" style="width: 379px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
			        	<select class="select" id="srvgroup" onmouseup="$('srvgroup_').set('checked', true)" style="width: 379px;">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select class="select" id="admwebflag" name="admwebflag" onblur="getMultiple(this, 1);" size="5" multiple onmouseup="$('admwebflags_').set('checked', true)" style="width: 379px;">
				...
				<tr>
			        ...
			        <td class="listtable_1" >
						<select class="select" id="admwebflag" name="admsrvflag" onblur="getMultiple(this, 2);" size="5" multiple onmouseup="$('admsrvflags_').set('checked', true)" style="width: 379px;">
			    ...
			    <tr>
			        ...
			        <td class="listtable_1" >
						<select class="select" id="server" onmouseup="$('admin_on_').set('checked', true)" style="width: 379px;">
