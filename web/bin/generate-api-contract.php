...
function renderContract(array $actions, array $docs, array $perms): string
{
    ...
    $out  = "// SourceBans++ (c) 2014-2026 SourceBans++ Dev Team\n";
    $out .= "// Licensed under the Elastic License 2.0.\n";
    $out .= "// See LICENSE.txt for the full license text and THIRD-PARTY-NOTICES.txt for attributions.\n";
    $out .= "//\n";
