...
<link rel="Shortcut Icon" href="themes/{$theme_name}/assets/images/favicon.ico" />
<script type="text/javascript" src="./scripts/fontawesome-all.min.js"></script>
<script type="text/javascript" src="./scripts/sourcebans.js"></script>
<script type="text/javascript" src="./scripts/mootools.js"></script>
<script type="text/javascript" src="./scripts/contextMenoo.js"></script>
<!-- bundle css -->
<link href="themes/{$theme_name}/assets/css/bundle.min.css" rel="stylesheet" type="text/css" />
<!-- /bundle -->
<!-- bundle js -->
<script type="text/javascript" src="themes/{$theme_name}/assets/js/bundle.min.js"></script>
<!-- /bundle -->
