                                        ...
                                        <tr>
                                            ...
                                            <td width="355px" class="listtable_2 opener" valign="top" style="padding-right: 0px; padding-left: 13px; padding-top: 12px;">
                                                ...
                                                <div align='center'>
                                                    ...
                                                    <div style='padding-right:13px;'<a href="https://www.gametracker.com/server_info/{$server.ip}:{$server.port}/" target="_blank"><img src="https://cache.gametracker.com/server_info/{$server.ip}:{$server.port}/b_350_20_312723_2a2723_ffffff_2a2723.png" border="0" width="350" height="20" alt=""/></a></div>
                                                    {/if}
