...
if (isset($_POST['name'])) {
    ...
    } elseif (($_POST['type'] == 0 && !is_numeric($_POST['steam']) && !validate_steam($_POST['steam'])) || (is_numeric($_POST['steam']) && (strlen($_POST['steam']) < 15 || !validate_steam($_POST['steam'] = \SteamID\SteamID::toSteam2($_POST['steam']))))) {
        $error++;
